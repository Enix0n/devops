        ...
        game.GameView = (function () {
            ...
            GameView.prototype.setGameCaption = function (name, status) {
                ...
                utils.reWriteDomElement(
                    ...
                    `<p class="navbar-text" >
                        ${name}
                        <span class="label label-warning">${utils.getStatusName(status)}</span>
                    </p>`
                );
            };
            GameView.prototype.setTimer = function (data) {
                ...
                utils.reWriteDomElement(this.game.$switchTimer, `<span class='game-timer-ok'${timerState}'>${minutes}:${seconds}</span>`);
            };
            ...
            GameView.prototype.setTeamCaption = function (team, $team) {
                ...
                utils.reWriteDomElement($team.$caption, `<div class='game-team-${role}-caption'>
                    <span class='teamCaption'>${team.name}${ROLE_TITLES[team.role] || ROLE_TITLES[team.role]}</span>
                    </div>`
                );
            };
            ...
            GameView.prototype.setButtons = function (status) {
                ...
                //
                if(
                    this.state.status===GameApi.GameState.starting||
